...
try:
    ...
    all_asm_file_paths = glob.glob("./patches/jp/*.asm")
    ...
    for patch_filename in all_asm_files:
        ...
        patch_path = os.path.join(".", "patches", "jp", patch_filename)
    ...
    map_rel(
        os.path.join(temp_dir, "jp_dyn.lst"),
        None,
        os.path.join(temp_dir, "jp.lst"),
        0,
        [custom_elf],
    )
