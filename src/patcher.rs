...
pub fn do_gz_patches(version: GameVersion) -> Result<(), Error> {
...
fn copy_practice_saves(patch_data: &PatchData) -> Result<(), Error> {
...
fn copy_custom_rel(patch_data: &PatchData) -> Result<usize, Error> {
...
fn add_free_space_section(dol: &mut Dol, bytes: &[u8], version: GameVersion) {
